...
latex_documents = [
    ('index', 'neasqc.tex', 'HQI-WP4 Documentation',
     'The HQI-WP4 Project Team', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = "logo_HQI_RVB.jpg"
...
man_pages = [
    ('index', 'neasqc', 'HQI-WP4 Documentation',
     ['The HQI-WP4 Project Team'], 1)
]
...
texinfo_documents = [
    ('index', 'neasqc', 'HQI-WP4 Documentation',
     'HQI-WP4 Project Team', 'HQI-WP4', 'One line description of project.',
     'Miscellaneous'),
]
